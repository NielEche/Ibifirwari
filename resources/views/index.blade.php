...
@endif
            ...
            <div class="p-6 lg:p-8">  
                <div class="mb-20">
                    <div class="">
                        <div class="max-w-5xl mx-auto lg:px-12  py-32 bg-black rounded-lg  flex">
                          <div class="flex justify-center h-full text-center">
                            <p class="mt-4 text-white lg:text-xl text-lg leading-relaxed"><span class="text-orange-500 font-black">IbifiriWari,</span> is a creative agency specializing in creative management, development and strategy, curation, creative business development and production. We work as a conduit between 
                            <br><span id="dynamic-text" class=" font-black text-orange-500 leading-relaxed"></span> committed to the development of creative and cultural ecosystems supporting creatives, culture workers, organizations and businesses across industries. 
                            </p>
                        ...
                        <div class="max-w-5xl mx-auto scale-100 py-16 bg-black rounded-lg">
                            ...
                            <h2 class=" text-3xl font-black pb-10 text-orange-500">In this house… We do really cool and good stuff </h2>
                                <div class="lg:grid grid-cols-3 gap-4">
                                   
                                     <div class="relative overflow-hidden rounded-lg lg:h-96 py-2">
                                            <div class="carousel rounded-lg">
                                                <div class="carousel-inner2 rounded-lg">
                                                    <div class="carousel-item2 flex justify-center" data-title="Slide">
                                                        <img style="object-fit:cover;" class="rounded-lg inset-0" src="https://res.cloudinary.com/nieleche/image/upload/v1710855657/unnamed_2_eugka5.jpg" alt="">
                                                    </div>
                                            
                                                    <div class="carousel-item2  flex justify-center" data-title="Slide">
                                                        <img style="object-fit:cover;"  class="rounded-lg inset-0" src="https://res.cloudinary.com/nieleche/image/upload/v1710855657/unnamed_1_o6durn.jpg" alt="">
                                                    </div>
                                                    <div class="carousel-item2 flex justify-center" data-title="Slide">
                                                        <img style="object-fit:cover;"  class="rounded-lg inset-0" src="https://res.cloudinary.com/nieleche/image/upload/v1709559788/DSC_7492_u3regg.jpg" alt="">
                                                    </div>
                                                    <div class="carousel-item2 flex justify-center" data-title="Slide">
                                                        <img style="object-fit:cover;"  class="rounded-lg inset-0" src="https://res.cloudinary.com/nieleche/image/upload/v1709559783/DSC_7498_eiblxb.jpg" alt="">
                                                    </div>
                                                    <div class="carousel-item2 flex justify-center" data-title="Slide">
                                                        <img style="object-fit:cover;"  class="rounded-lg inset-0" src="https://res.cloudinary.com/nieleche/image/upload/v1710855658/unnamed_3_poqjfw.jpg" alt="">
                                                    </div>
                                                </div>
                                        
                                            </div>
                                        <div class="lg:flex hidden absolute inset-0 px-6 flex-col items-center justify-center opacity-0 hover:opacity-100 transition duration-300 bg-black bg-opacity-50">
                                        ...
                                        <div class="lg:hidden  inset-0 block flex flex-col py-4 justify-center text-left">
                                            <p class="text-white text-base font-bold"> Hair Today, GONE Tomorrow, 2023</p>
                                            <p class="text-white text-xs ">Curated by Tamunoibifiri "Firi" Fombo for IbifiriWari Installation at Richmond Hill Central Library.</p> 
                                            <a href="#"  x-data="" x-on:click.prevent="$dispatch('open-modal', 'project1')" id="add-feature-button" class="text-white text-sm font-bold py-4">View More</a>
                                        </div>
                                     ...
                                     <div class="relative overflow-hidden rounded-lg lg:h-96 py-2">
                                        <div class="carousel rounded-lg">
                                            <div class="carousel-inner3 rounded-lg">
                                                <div class="carousel-item3" data-title="Slide">
                                                    <img style="object-fit:cover;" class="rounded-lg inset-0" src="https://res.cloudinary.com/nieleche/image/upload/v1710857345/unnamed_7_kab76w.jpg" alt="Image 3" class=" inset-0 w-full h-full object-cover">
                                                </div>
                                                <div class="carousel-item3" data-title="Slide">
                                                    <img style="object-fit:cover;" class="rounded-lg inset-0"  src="https://res.cloudinary.com/nieleche/image/upload/v1710857344/unnamed_6_gsddbd.jpg" alt="Image 3" class=" inset-0 w-full h-full object-cover">
                                                </div>
                                                <div class="carousel-item3" data-title="Slide">
                                                    <img style="object-fit:cover;" class="rounded-lg inset-0"  src="https://res.cloudinary.com/nieleche/image/upload/v1710857344/unnamed_4_yrn5i9.jpg" alt="Image 3" class=" inset-0 w-full h-full object-cover">
                                                </div>
                                                <div class="carousel-item3" data-title="Slide">
                                                    <img style="object-fit:cover;" class="rounded-lg inset-0"  src="https://res.cloudinary.com/nieleche/image/upload/v1710857344/unnamed_5_vy7yqj.jpg" alt="Image 3" class=" inset-0 w-full h-full object-cover">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="lg:flex hidden absolute inset-0 px-6  flex-col items-center justify-center opacity-0 hover:opacity-100 transition duration-300 bg-black bg-opacity-50">
                                     ...
                                     <div class="relative overflow-hidden rounded-lg lg:h-96 py-2">
                                        <div class="carousel">
                                            <div class="carousel-inner4">
                                                <div class="carousel-item4" data-title="Slide">
                                                    <img style="object-fit:cover;" class="rounded-lg inset-0"  src="https://res.cloudinary.com/nieleche/image/upload/v1710863771/unnamed_9_co7uzv.jpg" alt="Image 3" class=" inset-0 w-full h-full object-cover">
                                                </div>
                                                <div class="carousel-item2" data-title="Slide">
                                                    <img style="object-fit:cover;" class="rounded-lg inset-0"  src="https://res.cloudinary.com/nieleche/image/upload/v1710863773/unnamed_8_iwrhta.jpg" alt="Image 3" class=" inset-0 w-full h-full object-cover">
                                                </div>
                                                <div class="carousel-item2" data-title="Slide">
                                                    <img style="object-fit:cover;" class="rounded-lg inset-0"  src="https://res.cloudinary.com/nieleche/image/upload/v1710863771/unnamed_tz9q8a.png" alt="Image 3" class=" inset-0 w-full h-full object-cover">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="lg:flex hidden absolute inset-0 px-6  flex-col items-center justify-center opacity-0 hover:opacity-100 transition duration-300 bg-black bg-opacity-50">
                                    ...
                                    <div class="relative overflow-hidden rounded-lg lg:h-96 py-2">
                                        <img src="https://res.cloudinary.com/nieleche/image/upload/v1710863969/unnamed_11_wnf9qd.jpg" alt="Image 3" class="rounded-lg inset-0 w-full h-full object-cover">
                                        <div class="lg:flex hidden absolute inset-0 px-6  flex-col items-center justify-center opacity-0 hover:opacity-100 transition duration-300 bg-black bg-opacity-50">
                                    ...
                                    <div class="relative overflow-hidden rounded-lg lg:h-96 py-2">
                                        <img src="https://res.cloudinary.com/nieleche/image/upload/v1710864151/unnamed_12_a0olm6.jpg" alt="Image 3" class="rounded-lg inset-0 w-full h-full object-cover">
                                        <div class="lg:flex hidden absolute inset-0 px-6  flex-col items-center justify-center opacity-0 hover:opacity-100 transition duration-300 bg-black bg-opacity-50">
                                            <p class="text-white text-base font-bold">Archiving Culture through Hair and Beauty in Black Canadian Communities</p>
                        ...
                        <div class="max-w-9xl mx-auto scale-100 py-16 bg-black rounded-lg flex justify-center">
                            <div class="flex flex-col justify-center h-full text-center">
                              <h2 class=" text-3xl font-semibold  pb-10 text-orange-500">What we get up to in this house</h2>
                                <style>
                                    .shape {
                                        width: 300px;
                                        height:200px;
                                ...
                                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                                    <div class="relative shape2 lg:flex justify-center items-center group py-6">
                                        <h3 class="text-white text-center font-black text-sm p-4 lg:px-24">Creative Solutions for businesses and non-profit organizations</h3>
                                        <div class="lg:absolute text-white text-left text-sm left-0 w-full lg:p-4 bg-black lg:hidden lg:group-hover:block lg:px-10 lg:overflow-y-auto max-h-48">
                                            <ul class="list-disc">
                                                <li>Facilitating strategic Partnerships | Collaborations | Sponsorships opportunities.</li>
                                                <li>Developing and implementing community engagement and development strategies.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="relative lg:shape shape2 lg:flex justify-center items-center group py-6">
                                        <h3 class="text-white text-center font-black text-sm p-4">Creative Management and Development</h3>
                                        <div class="lg:absolute text-white text-left text-sm left-0 w-full lg:p-4 bg-black lg:hidden lg:group-hover:block lg:px-10  lg:overflow-y-auto max-h-48">
                                            <ul class="list-disc">
                                                <li>Managing and developing creative talents.</li>
                                                <li>Facilitating the development of creative and cultural projects and ideas from ideation to excellent execution.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="relative shape2 lg:flex justify-center items-center group py-6">
                                        <h3 class="text-white text-center font-black text-sm p-4">Creative Production</h3>
                                        <div class="lg:absolute text-white text-left text-sm left-0 w-full lg:p-4 bg-black lg:hidden lg:group-hover:block lg:px-10 lg:overflow-y-auto max-h-48">
                                            <ul class="list-disc">
                                                <li>Media campaign development and production.</li>
                                                <li>Strategic communications and outreach.</li>
                                                <li>Story development consultations.</li>
                                                <li>Creative and cultural direction.</li>
                                            </ul>
                                        </div>
                                    </div>
                                    <div class="relative lg:shape shape2 lg:flex justify-center items-center group py-6">
                                        <h3 class="text-white text-center font-black text-sm p-4">Exhibitions, Programming and Events</h3>
                                        <div class="lg:absolute text-white text-left text-sm left-0 w-full lg:p-4 bg-black lg:hidden lg:group-hover:block lg:px-10 lg:overflow-y-auto max-h-48">
                                            <ul class="list-disc">
                                            <li>Event planning and production.</li>
                                            <li>Program development consultation.</li>
                                            <li>Exhibition curation advisory.</li>
                                            </ul> 
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="max-w-5xl mx-auto py-16 scale-100 p-6 bg-black">
                          <div class="flex flex-col justify-center text-center">
                              <h2 class=" text-3xl font-semibold py-10 text-orange-500">We know you want to do some good work with us.. Send us a message!</h2>
                        ...
                        <div class="max-w-5xl mx-auto py-16 scale-100 p-6 bg-black">
                          <div class="flex flex-col justify-center text-center">
                              <h2 class=" text-xl font-semibold lg:px-16 py-10 text-orange-500">We enjoy sharing gists and inside inside information on what we are up to, stories from some good people we know and you might know and some extra gems.</h2>
